...
func (s *Bag) GetItems() *gsmodel.DMap[uint64, *common_model.Item] {
	return s.items
}
func (s *Bag) SetItems(v *gsmodel.DMap[uint64, *common_model.Item]) {
	if v != nil {
		v.SetParent(0, s.UpdateDirty)
	}
	s.items = v
...
func (s *Mail) GetRewards() *gsmodel.DList[*common_model.Item] {
	return s.rewards
}
func (s *Mail) SetRewards(v *gsmodel.DList[*common_model.Item]) {
	if v != nil {
